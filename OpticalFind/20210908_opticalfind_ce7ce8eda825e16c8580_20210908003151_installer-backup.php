...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210908_opticalfind_ce7ce8eda825e16c8580_20210908003151_archive.zip';
	const ARCHIVE_SIZE		 = '305987225';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ce7ce8e-08003151';
    const SECONDARY_PACKAGE_HASH = '2327cdd-08003151';
	const VERSION			 = '1.4.2';
