...
class WCMp_Frontend {
    ...
    function wcmp_save_extra_register_fields($customer_id) {
        ...
        global $WCMp;
        //$indexCompleted = array_search('vendor_page_title', $_POST['wcmp_vendor_fields']);
        if (array_key_exists('vendor_page_title', $_POST['wcmp_vendor_fields'])) {
            unset($_POST['wcmp_vendor_fields']['vendor_page_title']);
        }
        if (array_key_exists('vendor_address_1', $_POST['wcmp_vendor_fields'])) {
            unset($_POST['wcmp_vendor_fields']['vendor_address_1']);
        }
        if (array_key_exists('vendor_address_2', $_POST['wcmp_vendor_fields'])) {
            unset($_POST['wcmp_vendor_fields']['vendor_address_2']);
        }
        if (array_key_exists('vendor_postcode', $_POST['wcmp_vendor_fields'])) {
            unset($_POST['wcmp_vendor_fields']['vendor_postcode']);
        }
        if (array_key_exists('vendor_city', $_POST['wcmp_vendor_fields'])) {
            unset($_POST['wcmp_vendor_fields']['vendor_city']);
        }
