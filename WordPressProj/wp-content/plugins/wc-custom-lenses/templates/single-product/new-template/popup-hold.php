            ...
            <div class="<?php echo $class; ?>">     
                ...
                <div id="select-option-tab" class="resp-tabs-list">
                    ...
                    <?php if($kmcl_add_prescription_lenses == 'yes'){?>             
                        <input checked="checked" class="next-step lenses-category" type="radio" id="single-vision" name="lenses-category" value="skip-category">                <?php   }else{  }?>
                        <?php if($kmcl_add_prescription_lenses == 'yes'){                                   }
                        else{   ?>                  
                            ...
                            <div class="table-body table-row">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="sph-right" id="sph-right" class="fancy-select">
                                                        <?php for ($i = 6.00; $i >= -12.00; $i = $i - 0.25): ?>
                                                            <option value="<?php echo number_format((float)$i, 2, '.', ''); ?>">
                                      ...
                                      <div class="table-col">
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="power-right" id="power-right" class="fancy-select">
                                                    <option value=""></option>
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="bc-right" id="bc-right" class="fancy-select">
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="boxes-right" id="boxes-right" class="fancy-select">
                                  ...
                                  <div class="table-col">
                                    ...
                                    <div class="td-element">
                                        ...
                                        <div class="select-wrap">
                                            ...
                                            <select name="power-left" id="power-left" class="fancy-select">
                                              <option value=""></option>
                                              <?php for ($i = -12.00; $i <= 8.00; $i = $i + 0.50): ?>
                                                <option value="<?php echo number_format((float)$i, 2, '.', ''); ?>">
                                                    <?php echo number_format((float)$i, 2, '.', ''); ?>
                                ...
                                <div class="td-element">
                                    ...
                                    <div class="select-wrap">
                                        ...
                                        <select name="bc-left" id="bc-left" class="fancy-select">
                                ...
                                <div class="td-element">
                                    ...
                                    <div class="select-wrap">
                                        ...
                                        <select name="boxes-left" id="boxes-left" class="fancy-select">
