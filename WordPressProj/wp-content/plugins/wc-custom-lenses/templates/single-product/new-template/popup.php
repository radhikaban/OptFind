...
$kmcl_add_prescription_lenses = get_post_meta($post_id,'kmcl_add_prescription_lenses',true);

if(get_post_meta($post_id,'kmcl_addon_lenses',true) == 'yes'){
    $kmcl_add_prescription_lenses = "no";
}else{
    $kmcl_add_prescription_lenses = "yes";
}
...
<div id="option-wrap" class="option-swatch">
    ...
    <div class="row steps-opt">
       <?php      if($kmcl_add_prescription_lenses == 'yes'){     }else{      ?>
        <div class="col-md-6" >
        ...
        <?php if($kmcl_add_prescription_lenses == 'yes'){                                                       }else{                  foreach ($taxonomies as $taxonomy): ?>                <img id="side-view<?php echo $taxonomy->term_id; ?>" class="side-view"                     alt="<?php echo $taxonomy->name; ?>"                     src="<?php echo site_url(''); ?>/wp-content/plugins/wc-custom-lenses/img/<?php echo $taxonomy->term_id ?>.png"                     data-index="<?php echo $taxonomy->term_id; ?>">            <?php endforeach;                                   } ?>



        </div>      <?php       }               
        if($kmcl_add_prescription_lenses == 'yes'){         
            $class='col-md-12';     }else{          
                $class='col-md-12';      
            }       
            ?>
            <div class="<?php echo $class; ?>">     
                <?php       
                if($kmcl_add_prescription_lenses == 'yes'){                     
                    $title= 'Add Prescription';     }else{          
                        $title= 'Add Prescription';   //Editor’s Collection               
                    }       ?>
                    <h2 class="h1 title"><?php echo $title; ?> 
                    <!-- <span>Fresh Picks for 2017</span> -->
                </h2>
                <div id="select-option-tab" class="resp-tabs-list">

                    <div id="km-loader"><i class="fa fa-spin fa-spinner"></i></div>    
                    
                    <?php if($kmcl_add_prescription_lenses == 'yes'){?>             
                        <input checked="checked" class="next-step lenses-category" type="radio" id="single-vision" name="lenses-category" value="skip-category">    
                        <?php   }else{  }?>
                        <?php if($kmcl_add_prescription_lenses == 'yes'){                                   }
                        else{   ?>                  
                            ...
                            <section>                    
                                ...
                                <div class="text-center button-container">
                                 <a class="btn btn-default btn-next next-click" href="#">Next</a>                   
                             </div>                
                         </section>                   
                     <?php } ?>


                     <h2><span id="return-tab">Add Prescription</span></h2>
                     <section>
                            ...
                            <div class="table-body table-row">
                                        ...
                                        <div class="table-col">
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select  name="sph-right" id="sph-right" class="fancy-select fa-select">
                                                        <?php for ($i = 6.00; $i >= -12.00; $i = $i - 0.25): ?>
                                                        
                                                           <?php  $input_val = number_format((float)$i, 2, '.', '');
                                                                $in_val = $input_val == 0.00 ? "" : $input_val;
                                                                $selected = $input_val == 0.00 ? "selected" :"" ?> 
                                                            <option <?php echo $selected  ?> value="<?php echo $input_val; ?>">
                                                                <?php echo number_format((float)$i, 2, '.', ''); ?>
                                                            </option>
                                                        <?php endfor; ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select  name="cyl-right" id="cyl-right" class="fancy-select fa-select">
                                                        ...
                                                        <?php for ($i = 3.75; $i >= -3.75; $i = $i - 0.25): ?>
                                                         <?php  $input_val = number_format((float)$i, 2, '.', '');
                                                                $in_val = $input_val == 0.00 ? "" : $input_val;
                                                                $selected = $input_val == 0.00 ? "selected" : "" ?> 
                                                            <option <?php echo $selected ?> value="<?php echo $input_val; ?>"><?php echo number_format((float)$i, 2, '.', ''); ?></option>
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="axis-right" id="axis-right" class="fancy-select fa-select">
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select  name="add-right" id="add-right" class="fancy-select fa-select">
                                        ...
                                        <div class="table-col">
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="sph-left" id="sph-left" class="fancy-select fa-select">
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="cyl-left" id="cyl-left" class="fancy-select fa-select">
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="axis-left" id="axis-left" class="fancy-select fa-select">
                                            ...
                                            <div class="td-element">
                                                ...
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="add-left" id="add-left" class="fancy-select fa-select">
                                      ...
                                      <div class="table-col">
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="power-right" id="power-right" class="fancy-select fa-select">
                                                    <option value=""></option>
                                                    <?php for ($i = -12.00; $i <= 8.00; $i = $i + 0.50): ?>
                                                    <?php  $input_val = number_format((float)$i, 2, '.', '');
                                                                $in_val = $input_val == 0.00 ? "" : $input_val;
                                                                $selected = $input_val == 0.00 ? "selected" : "" ?> 
                                                        <option <?php echo $selected ?> value="<?php echo $input_val; ?>">
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="bc-right" id="bc-right" class="fancy-select fa-select">
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap"> 14.0  </div>
                                        ...
                                        <div class="td-element">
                                            ...
                                            <div class="select-wrap">
                                                ...
                                                <select name="boxes-right" id="boxes-right" class="fancy-select fa-select">
                                ...
                                <div class="table-col-10">
                                  <div class="table-col">
                                    ...
                                    <div class="td-element">OD (Left)</div>

                                    <div class="td-element">

                                        <div class="select-wrap">

                                            <select name="power-left" id="power-left" class="fancy-select fa-select">
                                              <option value=""></option>
                                              <?php for ($i = -12.00; $i <= 8.00; $i = $i + 0.50): ?>
                                               <?php  $input_val = number_format((float)$i, 2, '.', '');
                                                                $in_val = $input_val == 0.00 ? "" : $input_val;
                                ...
                                <div class="td-element">
                                    ...
                                    <div class="select-wrap">
                                        ...
                                        <select  name="bc-left" id="bc-left" class="fancy-select fa-select">
                                ...
                                <div class="td-element">
                                    ...
                                    <div class="select-wrap">
                                        ...
                                        <select  name="boxes-left" id="boxes-left" class="fancy-select fa-select">
                        ...
                        <div class="table-col-2">
                            ...
                            <div class="td-element">
                                ...
                                <div class="select-wrap">
                                    ...
                                    <select  name="pd" class="fancy-select fa-select twopd">
                ...
                <div class="text-center button-container">
                    ...
                    <a data-step="2" class="btn btn-default notskip move-next-to-second" href="#">Next</a>
            ...
            <div id="section-content-upload-prescription">
                ...
                <script>
                    ...
                    <div class="text-center button-container">
                        ...
                        <a class="btn btn-default btn-next on-image-upload" href="#">Next</a>
    ...
    <script>
        ...
        if(jQuery('#fav_button_warp').length > 0 ){
            jQuery('#fav_button_warp').each(function () {
                jQuery('[id="fav_button_warp"]:gt(0)').remove();
            });
        }
